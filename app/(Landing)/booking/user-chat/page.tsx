      ...
      <div className="flex flex-col h-screen bg-gray-100">
            ...
            <div key={message.id}>
              {message.sender === "bot" ? (
                <div className="flex flex-col">
                  ...
                  <div className="bg-white rounded-lg p-3 ml-10 max-w-[80%] text-gray-800">
                    <p>{message.text}</p>
                  </div>
                </div>
              ) : (
        ...
        <div className="bg-white border-t p-3">
          <form onSubmit={handleSendMessage} className="flex">
            ...
            <button
              type="submit"
              className="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
